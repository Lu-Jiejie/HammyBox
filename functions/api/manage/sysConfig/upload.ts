...
export async function getUploadConfig(db: ConfigStore, env: Env): Promise<UploadConfig> {
  ...
  // =====================读取r2渠道配置=====================
  const cfr2: Record<string, any> = {};
  const cfr2Channels: any[] = [];
  ...
  // =====================读取 HuggingFace 渠道配置=====================
  const huggingface: Record<string, any> = {};
  const huggingfaceChannels: any[] = [];
  ...
  // =====================读取 WebDAV 渠道配置=====================
  const webdav: Record<string, any> = {};
  const webdavChannels: any[] = [];
  ...
  return settings as UploadConfig;
}