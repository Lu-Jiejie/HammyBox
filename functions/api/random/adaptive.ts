...
interface DeviceInfo {
  source: 'client-hints' | 'user-agent' | null;
 ...
 *
 * @param headers - 响应头对象
 * @returns 添加了 Accept-CH 和 Vary 头的响应头对象
 */
export function addClientHintsHeaders(headers: Headers): Headers {
  // 设置 Accept-CH 头
